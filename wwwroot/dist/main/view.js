...
const EventBus = new (vue__WEBPACK_IMPORTED_MODULE_0___default())();
...
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ "vue");
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(vue__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var EventBus__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! EventBus */ "./src/EventBus.ts");
/* harmony import */ var FactionColors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! FactionColors */ "./src/FactionColors.ts");
/* harmony import */ var StatModalData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! StatModalData */ "./src/StatModalData.ts");
/* harmony import */ var api_CharacterKillApi__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! api/CharacterKillApi */ "./src/api/CharacterKillApi.ts");
...
vue__WEBPACK_IMPORTED_MODULE_0___default().component("player-kill-block", {
    ...
    methods: {
        getFactionColor: function (factionID) {
            return FactionColors__WEBPACK_IMPORTED_MODULE_2__.default.getFactionColor(factionID);
        },
        openCharacterWeaponKills: function (event, charID) {
            return __awaiter(this, void 0, void 0, function* () {
                const modalData = new StatModalData__WEBPACK_IMPORTED_MODULE_3__.StatModalData();
                const target = event.target;
                const kills = yield api_CharacterKillApi__WEBPACK_IMPORTED_MODULE_4__.CharacterKillApi.getWeaponEntries(charID);
                const totalKills = kills.reduce((acc, iter) => acc + iter.kills, 0);
                ...
                modalData.data = kills.map((iter) => {
                    return Object.assign(Object.assign({}, iter), { headshotRatio: `${(iter.headshotKills / iter.kills * 100).toFixed(2)}%`, percent: `${(iter.kills / totalKills * 100).toFixed(2)}%` });
                });
                EventBus__WEBPACK_IMPORTED_MODULE_1__.default.$emit("set-modal-data", modalData);
            });
        }
    },
    template: `
...
function vueMoment(input, format = "YYYY-MM-DD hh:mmA") {
    ...
    if (typeof input == "string") {
        ...
        return moment__WEBPACK_IMPORTED_MODULE_1__(input).format(format);
    }
    else if (input instanceof Date) {
        return moment__WEBPACK_IMPORTED_MODULE_1__(input).format(format);
    }
    else if (typeof input == "number") {
        return moment__WEBPACK_IMPORTED_MODULE_1__(new Date(input)).format(format);
    }
    else {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "StatModalData": () => /* binding */ StatModalData
/* harmony export */ });
class StatModalData {
    constructor() {
        this.data = [];
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CharacterWeaponKillEntry": () => /* binding */ CharacterWeaponKillEntry,
/* harmony export */   "CharacterKillApi": () => /* binding */ CharacterKillApi
/* harmony export */ });
...
class CharacterWeaponKillEntry {
    constructor() {
        this.weaponID = "";
        this.weaponName = "";
        this.kills = 0;
...
class CharacterKillApi {
    static get() { return CharacterKillApi._instance; }
    static parse(elem) {
        return {
    ...
    static getWeaponEntries(charID) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield axios__WEBPACK_IMPORTED_MODULE_0___default().get(`/api/kills/character/${charID}`);
            ...
            for (const datum of response.data) {
                const elem = CharacterKillApi.parse(datum);
                ret.push(elem);
            }
            return ret;
        });
...
CharacterKillApi._instance = new CharacterKillApi();
...
/* harmony import */ var _node_modules_popperjs_core_lib_popper__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../node_modules/@popperjs/core/lib/popper */ "./node_modules/@popperjs/core/lib/popper.js");
...
/* harmony import */ var EventBus__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! EventBus */ "./src/EventBus.ts");
/* harmony import */ var _BlockView__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./BlockView */ "./src/BlockView.ts");
/* harmony import */ var _KillData__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./KillData */ "./src/KillData.ts");
/* harmony import */ var _OutfitKillData__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./OutfitKillData */ "./src/OutfitKillData.ts");
/* harmony import */ var _InfoHover__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./InfoHover */ "./src/InfoHover.ts");
/* harmony import */ var _MomentFilter__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./MomentFilter */ "./src/MomentFilter.ts");
/* harmony import */ var StatModalData__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! StatModalData */ "./src/StatModalData.ts");
...
const vm = new (vue__WEBPACK_IMPORTED_MODULE_1___default())({
    ...
    created: function () {
        ...
        EventBus__WEBPACK_IMPORTED_MODULE_4__.default.$on("set-modal-data", (modalData) => {
    ...
    data: {
        ...
        connection: null,
        modalData: new StatModalData__WEBPACK_IMPORTED_MODULE_10__.StatModalData(),
        popperInstance: null,
    },
    methods: {
        ...
        subscribeBasedOnWorldPath: function () {
            ...
            if (parts.length == 3) {
                const world = parts[2].toLowerCase();
        ...
        setModalData: function (modalData) {
            ...
            this.$nextTick(() => {
                ...
                const tooltip = document.getElementById("stat-table");
                if (tooltip == null) {
                    console.error(`Missing tooltip element '#stat-table'`);
                    return;
                }
                const popper = (0,_node_modules_popperjs_core_lib_popper__WEBPACK_IMPORTED_MODULE_11__.createPopper)(modalData.root, tooltip, {
                    placement: "auto",
                });
                this.popperInstance = popper;
            });
        },
        closeStatTooltip: function () {
