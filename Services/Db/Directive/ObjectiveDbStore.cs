...
namespace watchtower.Services.Db {
    ...
    public class ObjectiveDbStore : BaseStaticDbStore<PsObjective> {

        public ObjectiveDbStore(ILoggerFactory loggerFactory,
            IDataReader<PsObjective> reader, IDbHelper helper)
            : base("objective", loggerFactory, reader, helper) { }

        internal override void SetupUpsertCommand(NpgsqlCommand cmd, PsObjective param) {
            cmd.CommandText = @"
