...
namespace watchtower.Services.Db {
    ...
    public class DirectiveTreeCategoryDbStore : IStaticDbStore<DirectiveTreeCategory> {
        ...
        public async Task<List<DirectiveTreeCategory>> GetAll(CancellationToken cancel = default) {
            ...
            List<DirectiveTreeCategory> dirs = await _Reader.ReadList(cmd, cancel);
