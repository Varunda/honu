...
namespace watchtower.Services.Db.Readers.Alert {
    ...
    public class AlertParticipantDataReader : IDataReader<AlertParticipantDataEntry> {

        public override AlertParticipantDataEntry? ReadEntry(NpgsqlDataReader reader) {
